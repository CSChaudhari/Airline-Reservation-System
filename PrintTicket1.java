...
public class PrintTicket1 extends JFrame {
    public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime) {
        ...
        JLabel LTicketNo = new JLabel("<html><font color=\"#000000\">Ticket NO: </font><font color=\"#778899\">" + random.nextInt() + "</font></html>");
        JLabel LBookedBy = new JLabel("<html><font color=\"#000000\">Booked By: Chaitanya Chaudhari</font></html>");

        JLabel LEmpty = new JLabel("---------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
        JLabel LDemo = new JLabel("<html><u><font color=\"#8FBC8F\">Airline-Project Developed By</font></u></html>");
        JLabel LChaitanya = new JLabel("<html><i><font color=\"#8FBC8F\">Chaitanya Chaudhari</font></i></html>");
        ...
        LChaitanya.setBounds(285, 485, 300, 20);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            new PrintTicket1("New York", "Los Angeles", "Business", 2, 1, 0, "2023-10-16", 800, "15:00");
        });
    }
}